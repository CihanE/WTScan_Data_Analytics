...
intro = "WTScan is a comprehensive data application that can simulate wind speeds globally and forecasts annual energy production for wind turbines. The app uses empirical weibull wind models to simulate annual wind speeds. It is able to deliver the wind turbines with the highest energy yields for various regions of the world. With WTScan, it is easy to analyze wind energy data, do benchmarks and make informed decisions."
